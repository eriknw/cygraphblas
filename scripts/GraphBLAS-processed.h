...
extern GrB_UnaryOp
    ...
    GxB_IDENTITY_FC32, GxB_AINV_FC32, GxB_MINV_FC32,
    GxB_IDENTITY_FC64, GxB_AINV_FC64, GxB_MINV_FC64,
...
extern
GrB_Info GxB_SelectOp_new
(
    GxB_SelectOp *selectop,
    GxB_select_function function,
    GrB_Type xtype,
    GrB_Type ttype
) ;
...
extern
GrB_Info GxB_Monoid_terminal_new_INT8
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    int8_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_UINT8
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    uint8_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_INT16
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    int16_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_UINT16
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    uint16_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_INT32
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    int32_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_UINT32
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    uint32_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_INT64
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    int64_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_FP32
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    float identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_FP64
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    double identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_FC32
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    GxB_FC32_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_FC64
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    GxB_FC64_t identity,
...
extern
GrB_Info GxB_Monoid_terminal_new_UDT
(
    GrB_Monoid *monoid,
    GrB_BinaryOp op,
    void *identity,
...
extern
GrB_Info GxB_Scalar_setElement_INT8
(
    GxB_Scalar s,
    int8_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_UINT8
(
    GxB_Scalar s,
    uint8_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_INT16
(
    GxB_Scalar s,
    int16_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_UINT16
(
    GxB_Scalar s,
    uint16_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_INT32
(
    GxB_Scalar s,
    int32_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_UINT32
(
    GxB_Scalar s,
    uint32_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_INT64
(
    GxB_Scalar s,
    int64_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_UINT64
(
    GxB_Scalar s,
    uint64_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_FP32
(
    GxB_Scalar s,
    float x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_FP64
(
    GxB_Scalar s,
    double x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_FC32
(
    GxB_Scalar s,
    GxB_FC32_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_FC64
(
    GxB_Scalar s,
    GxB_FC64_t x
) ;
...
extern
GrB_Info GxB_Scalar_setElement_UDT
(
    GxB_Scalar s,
    void *x
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_INT8
(
    int8_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_UINT8
(
    uint8_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_INT16
(
    int16_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_UINT16
(
    uint16_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_INT32
(
    int32_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_UINT32
(
    uint32_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_INT64
(
    int64_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_UINT64
(
    uint64_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_FP32
(
    float *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_FP64
(
    double *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Scalar_extractElement_FC64
(
    GxB_FC64_t *x,
    const GxB_Scalar s
) ;
...
extern
GrB_Info GxB_Vector_build_FC32
(
    GrB_Vector w,
    const GrB_Index *I,
    const GxB_FC32_t *X,
...
extern
GrB_Info GxB_Vector_build_FC64
(
    GrB_Vector w,
    const GrB_Index *I,
    const GxB_FC64_t *X,
...
extern
GrB_Info GxB_Vector_setElement_FC32
(
    GrB_Vector w,
    GxB_FC32_t x,
    GrB_Index i
...
extern
GrB_Info GxB_Vector_setElement_FC64
(
    GrB_Vector w,
    GxB_FC64_t x,
    GrB_Index i
...
extern
GrB_Info GxB_Vector_extractElement_FC32
(
    GxB_FC32_t *x,
    const GrB_Vector v,
    GrB_Index i
...
extern
GrB_Info GxB_Vector_extractTuples_FC32
(
    GrB_Index *I,
    GxB_FC32_t *X,
    GrB_Index *nvals,
...
extern
GrB_Info GxB_Matrix_build_FC32
(
    GrB_Matrix C,
    const GrB_Index *I,
    const GrB_Index *J,
...
extern
GrB_Info GxB_Matrix_build_FC64
(
    GrB_Matrix C,
    const GrB_Index *I,
    const GrB_Index *J,
...
extern
GrB_Info GxB_Matrix_setElement_FC32
(
    GrB_Matrix C,
    GxB_FC32_t x,
    GrB_Index i,
...
extern
GrB_Info GxB_Matrix_setElement_FC64
(
    GrB_Matrix C,
    GxB_FC64_t x,
    GrB_Index i,
...
extern
GrB_Info GxB_Matrix_extractElement_FC32
(
    GxB_FC32_t *x,
    const GrB_Matrix A,
    GrB_Index i,
...
extern
GrB_Info GxB_Matrix_extractElement_FC64
(
    GxB_FC64_t *x,
    const GrB_Matrix A,
    GrB_Index i,
...
extern
GrB_Info GxB_Matrix_extractTuples_FC64
(
    GrB_Index *I,
    GrB_Index *J,
    GxB_FC64_t *X,
...
extern
GrB_Info GxB_Matrix_Option_get
(
    GrB_Matrix A,
    GxB_Option_Field field,
    ...
...
extern
GrB_Info GxB_Global_Option_get
(
    GxB_Option_Field field,
    ...
) ;
...
extern
GrB_Info GxB_Vector_subassign_INT8
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_UINT8
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_INT16
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_UINT16
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_INT32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_UINT32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_INT64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_UINT64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_FP32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_FP64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_FC32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_FC64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_subassign_UDT
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_INT8
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_UINT8
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_INT16
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_UINT16
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_INT32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_UINT32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_INT64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_UINT64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_FP32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_FP64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_FC32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_FC64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_subassign_UDT
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_assign_FC32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_assign_FC64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_assign_FC32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_assign_FC64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_BOOL
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_INT8
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_INT16
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_INT32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_INT64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_UINT8
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_UINT16
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_UINT32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_UINT64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_FP32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp1st_FP64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_apply_BinaryOp1st_FC32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_apply_BinaryOp1st_FC64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_BOOL
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_INT8
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_INT16
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_INT32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_UINT8
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_UINT16
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_UINT32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_UINT64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_FP32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Vector_apply_BinaryOp2nd_FP64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_apply_BinaryOp2nd_FC32
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_apply_BinaryOp2nd_FC64
(
    GrB_Vector w,
    const GrB_Vector mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp1st_INT16
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp1st_INT32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp1st_UINT8
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp1st_UINT16
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp1st_UINT32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp1st_FP32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp1st_FP64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_apply_BinaryOp1st_FC32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_apply_BinaryOp1st_FC64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_BOOL
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_INT8
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_INT16
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_INT32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_INT64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_UINT8
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_UINT16
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_UINT64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GrB_Matrix_apply_BinaryOp2nd_FP32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_apply_BinaryOp2nd_FC32
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Matrix_apply_BinaryOp2nd_FC64
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_BinaryOp accum,
...
extern
GrB_Info GxB_Vector_reduce_FC32
(
    GxB_FC32_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GxB_Vector_reduce_FC64
(
    GxB_FC64_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_INT8
(
    int8_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_UINT8
(
    uint8_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_INT16
(
    int16_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_UINT16
(
    uint16_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_INT32
(
    int32_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_INT64
(
    int64_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_UINT64
(
    uint64_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_FP32
(
    float *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GrB_Matrix_reduce_FP64
(
    double *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GxB_Matrix_reduce_FC64
(
    GxB_FC64_t *c,
    const GrB_BinaryOp accum,
    const GrB_Monoid monoid,
...
extern
GrB_Info GxB_Descriptor_fprint
(
    GrB_Descriptor descriptor,
    const char *name,
    GxB_Print_Level pr,
...
extern
GrB_Info GxB_Matrix_export_CSC
(
    GrB_Matrix *A,
    GrB_Type *type,
    GrB_Index *nrows,
...
extern
GrB_Info GxB_Matrix_export_HyperCSR
(
    GrB_Matrix *A,
    GrB_Type *type,
    GrB_Index *nrows,
...
extern
GrB_Info GxB_Matrix_export_HyperCSC
(
    GrB_Matrix *A,
    GrB_Type *type,
    GrB_Index *nrows,
